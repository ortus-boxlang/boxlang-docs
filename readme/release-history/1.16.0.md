...
1.16.0 continues closing behavioral gaps for CFML and transpiled code:
...
* **[BL-2592](https://ortussolutions.atlassian.net/browse/BL-2592)**: Added missing `extract()` and `compress()` formats.
