...
Two new powerful component annotations for enhanced control:

```js
/**
 * @ignoreOutputOnly - Allows component output even when outputOnly=true in Application.bx
 */
component ignoreOutputOnly {
  writeOutput( "This will render!" );
}

/**
 * @autoEvaluateExpressions - Automatically evaluates interpolated expressions
 */
component autoEvaluateExpressions {
  property name="greeting" default="#now()#"; // Auto-evaluated
}
```
