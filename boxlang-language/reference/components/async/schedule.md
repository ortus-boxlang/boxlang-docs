...
| `action` | `string` | `true` |  |  |
| `task` | `string` | `false` |  |  |
| `scheduler` | `string` | `false` |  | `bxschedule` |
| `group` | `string` | `false` |  |  |
| `URL` | `string` | `false` |  |  |
| `class` | `string` | `false` |  |  |
| `method` | `string` | `false` |  | `run` |
| `interval` | `string` | `false` |  |  |
| `isDaily` | `boolean` | `false` |  | `false` |
| `cronTime` | `string` | `false` |  |  |
...
| `publish` | `boolean` | `false` |  | `false` |
| `path` | `string` | `false` |  |  |
| `file` | `string` | `false` |  |  |
| `overwrite` | `boolean` | `false` |  | `true` |
| `resolveUrl` | `boolean` | `false` |  | `false` |
| `retryCount` | `integer` | `false` |  | `3` |
| `onException` | `string` | `false` |  | `refire` |
| `onComplete` | `string` | `false` |  |  |
| `eventhandler` | `string` | `false` |  |  |
