...
| `sqltype` | `string` | `false` | The SQL type of the parameter. One of: `bigint`, `bit`, `blob`, `boolean`, `char`, `clob`, `date`, `decimal`, `double`, `float`, `int`, `integer`, `idstamp`, `longvarchar`, `money`, `numeric`, `real`, `smallint`, `string`,<br>                    `time`, `timestamp`, `tinyint`, `varbinary`, or `varchar`. |  |
