...
| `blockfactor` | `integer` | `false` | Maximum rows per block to fetch from the server. Ranges from 1-100. | `[ortus.boxlang.runtime.validation.dynamic.Min@3181fbe7, ortus.boxlang.runtime.validation.dynamic.Max@c8e99]` |
