...
| `filterDelimiters` | `string` | `false` | The delimiters to use for the filter - not implemented in the current release | `ortus.boxlang.runtime.validation.NotImplemented@6517bc6b` |
...
| `password` | `string` | `false` | The password to use for the Zip entry - not implemented in the current release | `ortus.boxlang.runtime.validation.NotImplemented@6517bc6b` |
| `encryptionAlgorithm` | `string` | `false` | The encryption algorithm to use for the Zip entry - not implemented in the current release | `ortus.boxlang.runtime.validation.NotImplemented@6517bc6b` |
