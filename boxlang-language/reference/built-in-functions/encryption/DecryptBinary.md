...
Decripts an encrypted and encoded binary object using the specified algorithm and key

## Method Signature

```
DecryptBinary(string=[string], key=[string], algorithm=[string], encoding=[string], IVorSalt=[any], iterations=[integer], precise=[boolean])
```
