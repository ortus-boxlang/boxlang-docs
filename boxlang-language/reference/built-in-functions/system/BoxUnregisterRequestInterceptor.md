...
# Function: `BoxUnregisterRequestInterceptor`
...
```
BoxUnregisterRequestInterceptor(interceptor=[any], states=[any])
```
...
|----------|------|----------|-------------|---------|
| `interceptor` | `any` | `true` | The reference to the interceptor to unregister |  |
| `states` | `any` | `false` | An array of events to unregister to along side the points discovered in the incoming interceptor. If not passed, all states | `[]` |
