...
specification (see [semver.org](http://semver.org) and [github](https://github.com/semver4j/semver4j)).

Some of the methods provided by Semver are:

* {@link Semver#compareTo(Semver)}: Compares two versions and returns -1, 0, or 1 if the first version is less than,\
