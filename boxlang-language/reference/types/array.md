...
* ,\
  ,
* ,`,row,`, or ,`,false,`,: Serializes the query as a top-level struct with two keys:\
  ,`,columns,`, (an array of column names) and ,`,data,`, (an array of arrays representing\
  each row's data).,
* ,\
  ,
* ,`,column,`, or ,`,true,`,: Serializes the query as a top-level struct with three keys:\
  ,`,rowCount,`, (the number of rows), ,`,columns,`, (an array of column names), and\
  ,`,data,`, (a struct where each key is a column name and the value is an array of values for that column).,
* ,\
  ,
