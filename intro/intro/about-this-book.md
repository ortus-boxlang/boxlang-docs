...
The source code for this book is hosted on GitHub: [https://github.com/ortus-solutions-private/boxlang-docs](https://github.com/ortus-solutions-private/boxlang-docs). You can freely contribute to it and submit pull requests. The contents of this book are copyrighted by [Ortus Solutions, Corp](http://www.ortussolutions.com/) and cannot be altered or reproduced without the author's consent. All content is provided _"As-Is"_ and can be freely distributed.‌
...
Flash, Flex, Boxlang, and Adobe are registered trademarks and copyrights of Adobe Systems
