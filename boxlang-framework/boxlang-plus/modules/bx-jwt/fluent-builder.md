...
The full method-by-method signatures live in the [JwtBuilder Fluent API Reference](reference/fluent-api/README.md).

## Related

* [JWTNew()](reference/built-in-functions/JWTNew.md)
* [JwtBuilder API Reference](reference/fluent-api/README.md)
